...
public class GPSTracker extends Service implements LocationListener, android.location.LocationListener {
    ...
    public void onLocationChanged(Location location) {
        if (location!=null) {
            if(location.hasAccuracy()) {
                Setup.getSetup().setLat(location.getLatitude());
                Setup.getSetup().setLon(location.getLongitude());
                Log.d("POSX", "AGGIORNATA");
                Log.d("POSX", String.valueOf(location.getLatitude()));
            }
        }
    }
    ...
    public void showSettingsAlert(){
        ...
        alertDialog.setTitle("Impostazioni Localizzazione");

        // Setting Dialog Message
        alertDialog.setMessage("Il GPS non è abilitato. Vuoi andare al menu di configurazione?");
